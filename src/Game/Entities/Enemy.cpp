...
Enemy::Enemy(string id, int health, int baseDamage, string entityName, int ox, int oy, string fightingpath, int fx, int fy, int fw, int fh) : Entity(ox, oy, 64, 64, "images/entities/enemy1/downframes/enemy1-ow-down1.png")
{
    this->id = id;
...
Enemy::Enemy(string id, int health, int baseDamage, string entityName, int ox, int oy, string fightingpath, int fx, int fy, int fw, int fh, bool isBoss) : Entity(ox, oy, 64, 64, "images/entities/enemy1/downframes/enemy1-ow-down1.png")
{
    this->id = id;
    this->entityName = entityName;
    moveTimer = 60;
