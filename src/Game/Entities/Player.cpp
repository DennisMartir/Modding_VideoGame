...
Player::Player(int health, int baseDamage,string fightingpath, int fx, int fy, int fw, int fh) : Entity(INIT_X, INIT_Y, 64, 64, "images/entities/player/downframes/player-ow-front1.png")
{
...
void Player::renderOverworld()
{
    ...
    // ofDrawBitmapString("Health: " + to_string(getHealth()), 05, 15);
