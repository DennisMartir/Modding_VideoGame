...
Boss::Boss(string id, int health, int baseDamage, string entityName, int ox, int oy, string fightingPath, int fx, int fy, int fw, int fh) : Enemy(id, health, baseDamage, entityName, ox, oy, "images/entities/enemy4/fightingframes/enemy4-f1.png", fx, fy, fw, fh, true)
{
    this->id = id;
